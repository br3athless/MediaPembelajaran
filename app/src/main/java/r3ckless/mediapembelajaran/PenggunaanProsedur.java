...
public class PenggunaanProsedur extends AppCompatActivity {
...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_penggunaan_prosedur);
        ...
        TextView myTextView = (TextView) findViewById(R.id.contentViewUseProc);
        ...
        FloatingActionButton myFabNext = (FloatingActionButton) findViewById(R.id.fabNext_UseProc);
        myFabNext.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent i = new Intent(PenggunaanProsedur.this, DefinisiFungsi.class);
                PenggunaanProsedur.this.startActivity(i);
            }
        });

        FloatingActionButton myFabPrev = (FloatingActionButton) findViewById(R.id.fabPrev_UseProc);
        myFabPrev.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent i = new Intent(PenggunaanProsedur.this, TtgProsedur.class);
                PenggunaanProsedur.this.startActivity(i);
            }
        });
    }
