...
public class TipeData extends AppCompatActivity {
...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tipe_data);
        ...
        TextView myTextView = (TextView) findViewById(R.id.contentViewData);
        ...
        FloatingActionButton myFabNext = (FloatingActionButton) findViewById(R.id.fabNext_TipeData);
        myFabNext.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent i = new Intent(TipeData.this, Operator.class);
                TipeData.this.startActivity(i);
            }
        });

        FloatingActionButton myFabPrev = (FloatingActionButton) findViewById(R.id.fabPrev_TipeData);
        myFabPrev.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent i = new Intent(TipeData.this, Pseudocode.class);
                TipeData.this.startActivity(i);
            }
        });
    }
