...
public class TtgProsedur extends AppCompatActivity {
...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ttg_prosedur);
        ...
        TextView myTextView = (TextView) findViewById(R.id.contentViewBoutProc);
        ...
        FloatingActionButton myFabNext = (FloatingActionButton) findViewById(R.id.fabNext_AboutProc);
        myFabNext.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent i = new Intent(TtgProsedur.this, PenggunaanProsedur.class);
                TtgProsedur.this.startActivity(i);
            }
        });

        FloatingActionButton myFabPrev = (FloatingActionButton) findViewById(R.id.fabPrev_AboutProc);
        myFabPrev.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent i = new Intent(TtgProsedur.this, Operator.class);
                TtgProsedur.this.startActivity(i);
            }
        });
    }
