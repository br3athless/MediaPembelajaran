...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView myTextView = (TextView) findViewById(R.id.contentViewOp);
        ...
        FloatingActionButton myFabNext = (FloatingActionButton) findViewById(R.id.fabNext_Op);
        myFabNext.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent i = new Intent(Operator.this, TtgProsedur.class);
                Operator.this.startActivity(i);
            }
        });

        FloatingActionButton myFabPrev = (FloatingActionButton) findViewById(R.id.fabPrev_Op);
        myFabPrev.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent i = new Intent(Operator.this, TipeData.class);
                Operator.this.startActivity(i);
            }
        });
    }
