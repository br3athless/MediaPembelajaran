...
public class JumlahDeretC extends AppCompatActivity {
    private StringBuilder text = new StringBuilder();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_jumlah_deret_c);
        ...
        TextView myTextView = (TextView) findViewById(R.id.contentViewSumDeretC);
        BufferedReader reader = null;

        try {
            reader = new BufferedReader(
                    new InputStreamReader(getAssets().open("penjumlahan deret c.txt")));
