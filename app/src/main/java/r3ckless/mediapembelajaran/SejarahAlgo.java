...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton myFabNext = (FloatingActionButton) findViewById(R.id.fabNext_histAlgo);
        myFabNext.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent i = new Intent(SejarahAlgo.this, StrukturUrut.class);
                SejarahAlgo.this.startActivity(i);
            }
        });

        FloatingActionButton myFabPrev = (FloatingActionButton) findViewById(R.id.fabPrev_histAlgo);
        myFabPrev.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent i = new Intent(SejarahAlgo.this, DefinisiAlgo.class);
                SejarahAlgo.this.startActivity(i);
            }
        });
