...
public class PenggunaanFungsi extends AppCompatActivity {
...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_penggunaan_fungsi);
        ...
        TextView myTextView = (TextView) findViewById(R.id.contentViewUseFunc);
...
//                Intent i = new Intent(PenggunaanFungsi.this, PenggunaanFungsi.class);
//                DefinisiFungsi.this.startActivity(i);
//            }
//        });

        FloatingActionButton myFabPrev = (FloatingActionButton) findViewById(R.id.fabPrev_UseFunc);
        myFabPrev.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent i = new Intent(PenggunaanFungsi.this, DefinisiFungsi.class);
                PenggunaanFungsi.this.startActivity(i);
            }
        });
    }
